...
public class Librarian extends Person implements User {
    ...
    public void preRegistered() {
        ...
        regReader[0] = new Reader(1, "111", "A", "a", "Student", 12L, "Aa", "A@gmail.com", false);
        regReader[1] = new Reader(2, "222", "B", "b", "Child", 11L, "Bb", "B@gmail.com", true);

        for (Reader reader : regReader) {
 ...
 + "Block:" + reader_list.get(i).isIsBlock());
    ...
    public Boolean checkReturnDate(int day, int month, int year) {
        ...
        return rentDate.compareTo(weekAgo) >= 0 && rentDate.compareTo(weekAgo) <= 7;
    }
